...
- [x] 게시글 삭제 될 때 alert로 알람이 뜨도록 변경
- [x] 화면을 작게 board/{postId}에서 창을 작게 했을 때 댓글 창 크기 맞추기
- [x] 새로운 게시글 작성 시 글 쓰는 길이 만큼 textarea가 길어지도록
- [x] modal로 댓글 수정시 데이터 넘기기
- [x] 데이터베이스에 데이터 저장(memory 대신)
- [ ] 댓글을 남기고 등록 버튼을 눌렀을 때 작성한 댓글이 나타나지 않는 문제 발생
- [x] post table의 post-content, comment-body 의 최대 글자 숫자 늘리기
